...
## **Binary Search**
### Key points
- [example](https://github.com/egorskikh/IOS-Data-Structures-and-Algorithms/tree/main/Section%203.%20Threes/binary-search/BinarySearch.playground)
- Binary search - действительный алгоритм только для отсортированных коллекций.
